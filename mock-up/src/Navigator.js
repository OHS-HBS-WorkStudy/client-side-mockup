        ...
        <div>
            <nav>
                ...
                <div className="link-container">
                    ...
                    <div className="a">
                        <CustomButton className="linkss" func={change_screen} data={1} name={"Sign-Up"} />
                        <CustomButton className="linkss" func={change_screen} data={2} name={"Login"} />
                        <CustomButton className="linkss" func={screen_switch} data={5} name={"New Question"} />
                        <CustomButton className="linkss" func={screen_switch} data={4} name={"Account"} />
                    </div>
                </div>
            </nav>
        </div>
